   ...
   */
   ...
   function showItems( accountData) { 
      ...
      transfers.forEach((bundle, index) => {
         ...
         var theStatus = (persisted ? " confirmed " : reattachConfirmed ? " bundle confirmed " : " pending ");
         console.log( "status="+theStatus+",time="+time);
...
//               'name': 'none',
   ...
   function getAccountInfoNew() {
      ...
      console.log("in getAccountInfoNew() for seed "+seed);
